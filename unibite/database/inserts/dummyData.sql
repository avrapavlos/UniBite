...
(1, 'Sandwich Platter from Seminar',           'Assorted sandwich halves left after a guest lecture, mostly turkey and hummus.',           2, 37.871900, -122.258500, 'Lecture Hall B',     '2',   5, '/uploads/ads/sandwiches.jpg',  'ACTIVE'),
(2, 'Fresh Fruit Bowls',                       'Pre-cut fruit bowls from a wellness fair, apples, grapes, and melon.',                     1, 37.872400, -122.259800, 'Recreation Center',  'Lobby',7, '/uploads/ads/fruit.jpg',       'ACTIVE'),
(3, 'Pasta Bake - Dorm Event Leftovers',       'Baked ziti from tonight''s dorm floor social, still warm.',                                3, 37.870600, -122.257100, 'Maple Hall',         'Common Room', 9, '/uploads/ads/pasta.jpg', 'ACTIVE'),
(4, 'Bagels & Cream Cheese',                   'Boxed bagels with a few tubs of cream cheese left from a morning meeting.',                1, 37.873100, -122.260200, 'Admin Building',     '112', 10,'/uploads/ads/bagels.jpg',      'INACTIVE'),
(1, 'Curry and Rice - Cultural Night',         'Chickpea curry and rice from the International Student Association cultural night.',      3, 37.871900, -122.258500, 'Global Center',      'Main Hall', 8, '/uploads/ads/curry.jpg', 'ACTIVE'),
(2, 'Soup and Bread - Charity Event',          'Vegetable soup and fresh bread rolls from tonight''s charity dinner.',                     2, 37.872400, -122.259800, 'Community Kitchen',  '1',   6, '/uploads/ads/soup.jpg',        'DELETED'),
(3, 'Cupcakes - Bake Sale Extras',             'Unsold cupcakes from the fundraiser bake sale, assorted flavors.',                         1, 37.870600, -122.257100, 'Student Union',      'Atrium', 15,'/uploads/ads/cupcakes.jpg',   'DELETED'),
(4, 'Falafel Wraps - Food Truck Leftovers',    'Falafel wraps that the food truck pop-up couldn''t sell before closing.',                  2, 37.873100, -122.260200, 'Quad',               'Food Truck Row', 5, '/uploads/ads/falafel.jpg', 'INACTIVE');
